...
<body> 
	...
	$sql = "INSERT INTO aluno (nome, celular, cpf, email, rg, telefone, datadenascimento, escolhasexo, necessidade_especial, senha, repetesenha,observacoes)
VALUES ('$nome', '$celular', '$cpf', '$email', '$rg', '$telefone', '$data', '$escolhasexo', '$necessidadeespecial', '$senha1', '$senha2','$observacoes')";
